/* =========================================================================
   Static reference data + seed data for the Prasad Info Tech CRM frontend.

   As of the Django backend integration, USERS / INITIAL_LEADS / etc. below
   are NO LONGER used by src/services/api.js — real data now comes from the
   API (see api.js + services/adapters.js). They're left here for reference
   / offline demoing. The constant lists (SERVICES, LEAD_SOURCES,
   LEAD_STATUSES, NAV_ITEMS, STATUS_STYLES, PRIORITY_STYLES, ROLES) ARE
   still actively used — those define dropdown options and status colors
   throughout the app.
   ========================================================================= */
